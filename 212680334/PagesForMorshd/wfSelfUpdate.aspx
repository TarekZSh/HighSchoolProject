<%@ Page Title="" Language="C#" MasterPageFile="~/PagesForMorshd/mpMorshd.master" AutoEventWireup="true" CodeFile="wfSelfUpdate.aspx.cs" Inherits="PagesForMorshd_wfSelfUpdate" %>
    ...
    <p>
        <table style="width: 449px; height: 169px">
            <tr>
                ...
                <td style="width: 353px">Update My Data</td>
                <td style="width: 48px">
            ...
            <tr>
                ...
                <td style="width: 353px; height: 91px">
                    <asp:ImageButton ID="ibtUpdate" runat="server" AlternateText="Add" ImageUrl="~/Images/Edit.png" OnClick="ibtUpdate_Click" Height="50px" Width="50px" />
                </td>
